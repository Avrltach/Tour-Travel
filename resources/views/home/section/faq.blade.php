    ...
    <div class="max-w-3xl mx-auto space-y-4">
      <div class="faq-item border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        <button class="faq-btn w-full flex justify-between items-center p-6 text-left">
          ...
          <svg class="w-6 h-6 md:w-8 md:h-8 arrow transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
        ...
        <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 bg-gray-100/50 dark:bg-gray-800/40">
          <p class="p-6 text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
            Anda dapat memesan paket wisata melalui website kami atau menghubungi customer service kami di WhatsApp. Tim kami akan membantu Anda memilih paket yang sesuai dengan kebutuhan dan budget Anda.
          </p>
        </div>
      </div>
      <div class="faq-item border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        <button class="faq-btn w-full flex justify-between items-center p-6 text-left">
          <span class="text-lg md:text-xl font-semibold text-gray-800 dark:text-white">
            Apakah saya bisa melakukan custom paket perjalanan?
          </span>
          <svg class="w-6 h-6 md:w-8 md:h-8 arrow transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
        ...
        <div class="faq-content max-h-0 overflow-hidden transition-all duration-300 bg-gray-100/50 dark:bg-gray-800/40">
          <p class="p-6 text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
            Tentu! Kami menyediakan layanan custom trip sesuai keinginan Anda. Hubungi tim kami untuk mendiskusikan destinasi, durasi, dan fasilitas yang Anda inginkan.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        <button class="faq-btn w-full flex justify-between items-center p-6 text-left">
          <span class="text-lg md:text-xl font-semibold text-gray-800 dark:text-white">
            Apa saja yang termasuk dalam paket wisata?
          </span>
          <svg class="w-6 h-6 md:w-8 md:h-8 arrow transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
      ...
      <div class="faq-item border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        <button class="faq-btn w-full flex justify-between items-center p-6 text-left">
          <span class="text-lg md:text-xl font-semibold text-gray-800 dark:text-white">
            Bagaimana kebijakan pembatalan dan refund?
          </span>
          <svg class="w-6 h-6 md:w-8 md:h-8 arrow transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
      ...
      <div class="faq-item border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
        <button class="faq-btn w-full flex justify-between items-center p-6 text-left">
          <span class="text-lg md:text-xl font-semibold text-gray-800 dark:text-white">
            Bagaimana jika saya ingin bergabung dengan grup terbuka?
          </span>
          <svg class="w-6 h-6 md:w-8 md:h-8 arrow transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
