<nav id="navbar" class="fixed top-0 left-0 w-full z-50 bg-transparant trasition-colors duration-300 ">
  <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
    <div class="flex items-center justify-between">
    <div class="flex items-center justify-between space-x-8 w-full">
   <div class="shrink-0 flex items-center space-x-2">
    <a href="#" class="flex items-center space-x-2">
      <img class="block w-auto h-8 dark:hidden" src="{{ asset('images/cakrawala.png') }}" alt="Logo">
      <img class="hidden w-auto h-8 dark:block" src="{{ asset('images/cakrawala.png') }}" alt="Logo Dark">
      <span class="text-lg font-semibold text-gray-900 dark:text-white">Cakrawala</span>
    </a>
  </div>
  <ul class="hidden lg:flex items-center gap-6 md:gap-8 py-3"> 
    ...
    <div id="ecommerce-navbar-menu-1" class="bg-gray-50 dark:bg-gray-700 dark:border-gray-600 border border-gray-200 rounded-lg py-3 hidden px-4 mt-4">
      <ul class="text-gray-900 dark:text-white text-sm font-medium dark:text-white space-y-3">
        ...
        <li>
          <a href="" class="hover:text-primary-700 dark:hover:text-primary-500">About Us</a>
        </li>
        <li>
          <a href="" class="hover:text-primary-700 dark:hover:text-primary-500">Package</a>
        </li>
        <li>
          <a href="" class="hover:text-primary-700 dark:hover:text-primary-500">Gallery</a>
        </li>
        <li>
          <a href="" class="hover:text-primary-700 dark:hover:text-primary-500">Contact</a>
        </li>
      </ul>
    </div>
  </div>
